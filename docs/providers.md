...
The local OpenAI-compatible base URL is `http://127.0.0.1:11434/v1`. MemXplore does not pull models automatically. Release and CI code must not call a cloud model; CI uses the deterministic fake provider.
